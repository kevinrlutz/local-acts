...
import { createVenueProfile } from "@/src/services/venues";
import {
    DayHours,
    DayOfWeek,
    DAYS_OF_WEEK,
...
export default function CreateVenueScreen() {
  ...
  useEffect(() => {
    if (typeof document !== "undefined") {
      document.title = "Create Venue Profile";
      return () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      let profileImageRef: string | null = null;
      if (profileImageUri) {
      ...
      router.replace(
        `${VENUE_PROFILE_ROUTE}?uid=${encodeURIComponent(venueId)}` as Href
      );
    } catch (err) {
      ...
      const message =
        err instanceof Error ? err.message : "Unable to create venue profile.";
      setError(message);
        ...
        >
          <View style={styles.container}>
            <View style={styles.header}>
              <Text style={styles.title}>Create a Venue Profile</Text>
              <Text style={styles.subtitle}>
                Help fans and acts discover your venue.
              </Text>
            </View>
            ...
            <View style={styles.formGroup}>
              ...
              <Text style={styles.helperText}>
                Type to search and select from the suggestions below.
              </Text>
              <TextInput
                value={addressQuery}
            ...
            <View style={styles.formGroup}>
              ...
              <Text style={styles.helperText}>
                Enter times in 24-hour format (e.g. 20:00 for 8 PM). A close
                time before open time (e.g. open 20:00, close 02:00) means the
